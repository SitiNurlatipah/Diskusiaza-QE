...
public class PostRegist5 {
    ...
    public String postregisendpoint5(){
        return url + "auth/register";
    }

    @Step("user regist using no input password")
    public void registUsingEmptyPassword(){
        ...
        SerenityRest.given().header("Content-Type", "application/json").body(requestBody.toJSONString()).post(postregisendpoint5());
    }
